...
import 'package:dwallet/app/web3/hdnode/hd_node.dart';
...
@immutable
class Wallet {
  static const defaultPath = "m/44'/60'/0'/0/0";
  ...
  factory Wallet.fromMnemonic(
    ...
    return Wallet._(EthPrivateKey.fromHex(HDNode.fromMnemonic(mnemonic).derivePath(path).privateKey!), derivator, passwordBytes, iv, uuid);
  }
