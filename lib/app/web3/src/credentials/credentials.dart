...
abstract class Credentials {
  ...
  /// signature.
  Future<secp256k1.MsgSignature> signToSignature(Uint8List payload,
...
class EthPrivateKey extends CredentialsWithKnownAddress {
  ...
  factory EthPrivateKey.createRandom(Random random) {
    final key = secp256k1.generateNewPrivateKey(random);
  ...
  Future<secp256k1.MsgSignature> signToSignature(Uint8List payload,
    ...
    return secp256k1.MsgSignature(signature.r, signature.s, chainIdV);
  }
