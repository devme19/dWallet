...
class TransactionWidgetItem extends StatelessWidget {
    ...
    return
      ...
      Column(
        children: [
          ...
          Column(
            children: [
              ...tx!.transactions!.reversed.map((e) =>  TransactionWidget(
                tx: e,
              ))
            ],
          ),
  ...
  String getDateTime(String dateTime){
    ...
    if(now.year == transactionDateTime.year){
      if(now.month == transactionDateTime.month){
        if(now.day == transactionDateTime.day){
          return "Today";
        }else
        if((now.day - transactionDateTime.day)==1){
          return "Yesterday";
        }
      }
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(DateFormat.Hm().format(DateTime.parse(tx.date!))),
